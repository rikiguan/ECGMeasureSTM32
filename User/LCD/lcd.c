...
void LCD_FillArray(uint16_t x0,uint16_t y0,uint16_t x1,uint16_t y1, uint8_t* pic)
{
//	uint16_t i,j,k=0;
...
//		}
//	}			
	HAL_SPI_Transmit(&hspi5,pic,2*(x1-x0+1)*(y1-y0+1),0xffff);
	//HAL_SPI_Transmit(&hspi5,(uint8_t*)pic,2*(x1-x0+1)*(y1-y0+1),0xffff);
//	HAL_SPI_Transmit_DMA(&hspi5,pic+(x1-x0+1)*(y1-y0+1),(x1-x0+1)*(y1-y0+1));
//	HAL_SPI_Transmit(&hspi5,pic,2*(x1-x0+1)*(y1-y0+1),1);
}
