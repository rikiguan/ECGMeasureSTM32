...
/******************************************************************************/
#define AI_QECG_MODEL_NAME          "qecg"
#define AI_QECG_ORIGIN_MODEL_NAME   "qecg_model"

/******************************************************************************/
#define AI_QECG_ACTIVATIONS_ALIGNMENT   (4)
#define AI_QECG_INPUTS_IN_ACTIVATIONS   (4)
#define AI_QECG_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_QECG_IN_NUM        (1)

AI_DEPRECATED
#define AI_QECG_IN \
  ai_qecg_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_QECG_IN_SIZE { \
  AI_QECG_IN_1_SIZE, \
}
#define AI_QECG_IN_SIZE_BYTES { \
  AI_QECG_IN_1_SIZE_BYTES, \
}
#define AI_QECG_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_QECG_IN_1_HEIGHT      (186)
#define AI_QECG_IN_1_CHANNEL     (1)
#define AI_QECG_IN_1_SIZE        (186)
#define AI_QECG_IN_1_SIZE_BYTES  (744)

/******************************************************************************/
#define AI_QECG_OUT_NUM       (1)

AI_DEPRECATED
#define AI_QECG_OUT \
  ai_qecg_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_QECG_OUT_SIZE { \
  AI_QECG_OUT_1_SIZE, \
}
#define AI_QECG_OUT_SIZE_BYTES { \
  AI_QECG_OUT_1_SIZE_BYTES, \
}
#define AI_QECG_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_QECG_OUT_1_CHANNEL     (5)
#define AI_QECG_OUT_1_SIZE        (5)
#define AI_QECG_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_QECG_N_NODES (10)
 ...
 * @ref ai_qecg_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_QECG_*
 * defines into file @ref qecg.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
